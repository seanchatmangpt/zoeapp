...
|---|------|-------|-------------|--------|
| 1 | Discovery & Analysis | Map out all old references, dependencies, and state mutation/UI structures | None | DONE |
| 2 | Rebranding & Dependencies | Rename files/folders, update package.json, replace terminology & imports | M1 | IN_PROGRESS (7b04901c) |
